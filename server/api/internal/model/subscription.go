...
// Subscription is the canonical "current entitlement" record. Phase 3 dropped
// the legacy provider column (migration 020) and adds lava_contract_id. The
// legacy plan-limits map is DELETED — limits now live in the plans table
// (queried via plan_repo).
